"""
Script to Visualise the Results of Training DS/ISAR Models on the MRC Harwell Data
"""
from scipy.stats import ttest_rel
import numpy as np
import argparse

DEFAULTS = {'Results': ['../../data/Results_DS.npz', '../../data/Results_ISAR.npz'],
            'Schemas': ['I', 'II', 'III', 'IV']}
...
if __name__ == '__main__':
    ...
    for s in range(len(args.schemas)):
        print(' Schema {:3} | {:.1f}% +/- {:.2f}% | {:.1f}% +/- {:.2f}% | t={:8.2f}, p={:.2e}'
